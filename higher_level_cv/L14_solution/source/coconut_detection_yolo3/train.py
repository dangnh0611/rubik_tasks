...
def _main():
    annotation_path = 'datasets/all_annotations.txt'
    log_dir = 'logs/03052019/'
    classes_path = 'model_data/coconut_classes.txt'
    anchors_path = 'model_data/coconut_anchors.txt'
    ...
    if is_tiny_version:
        ...
        model = create_model(input_shape, anchors, num_classes,
                             freeze_body=2,
                             weights_path='model_data/1.h5')  # make sure you know what you freeze
